...
TWILIO_WHATSAPP_FROM = os.environ.get("TWILIO_WHATSAPP_FROM") or os.environ.get("TWILIO_WHATSAPP_NUMBER")
...
def telegram_webhook():
    ...
    from_user = msg.get("from", {}).get("username", str(msg.get("from", {}).get("id", "")))
